...
def train_model(tokenizer, train_loader, val_loader, model, vocab_size, device, learning_rate, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            # FIXED: throughput calculation (added parentheses)
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = make_dataloaders(ids, seq_len=SEQ_LEN, batch_size=BATCH_SIZE)
